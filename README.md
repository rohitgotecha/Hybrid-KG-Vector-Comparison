...
- **Dataset Source**: Kaggle - Residency Listings
- **Framework**: Neo4j, FAISS, Sentence-Transformers, Google Gemini
- **Inspiration**: Hybrid retrieval research papers
...
```bibtex
@misc{gotecha2024hybrid,
  title={Hybrid Knowledge Graph & Vector Search Comparison for Real Estate},
  author={Gotecha, Rohit},
  year={2024},
  publisher={GitHub},
  url={https://github.com/yourusername/hybrid-kg-vector-comparison}
}
```

## 🚦 Project Status

- ✅ Completed: Comparison framework
- ✅ Completed: All 5 configurations tested
- ✅ Completed: Manual scoring system
- ✅ Completed: Analysis & recommendations
- 🔄 In Progress: Production deployment guide
- ⏳ Planned: Extended to other domains
